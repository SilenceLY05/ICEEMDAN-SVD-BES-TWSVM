...
def evolve_population(pop, BestSol, nPop, low, high, dim, X_train, y_train, MaxIt):
    ...
    for t in range(MaxIt):
        ...
        pop, BestSol, s2 = search_space(lambda ind: calculate_fitness(ind, X_train, y_train), pop, BestSol, nPop, low, high, t, MaxIt)
        pop, BestSol, s3 = swoop(lambda ind: calculate_fitness(ind, X_train, y_train), pop, BestSol, nPop,  low, high, t, MaxIt)
