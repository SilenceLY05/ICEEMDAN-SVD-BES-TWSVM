...
class ICEEMDAN:
    ...
    def iceemdan_and_denoise(self, original_signal, df):
        ...
        for i, imf in enumerate(imfs):
            # 使用排列熵
            embdim = 6  # 排列熵的嵌入维度，可调整
            embdelay = 1  # 排列熵的嵌入延迟，可调整
            entropy = Permutation_Entropy(imf, embdim, embdelay)
...
if __name__ == "__main__":
    input_folder = r'D:\毕业论文文件\OTDR_Data\Before treatment'
    output_folder = r'D:\毕业论文文件\OTDR_Data\After treatment'
