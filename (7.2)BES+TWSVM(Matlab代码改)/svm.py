...
class svm:
    ...
    def tune_rbf(self, X_train, y_train, X_test, y_test, K=5, plot=False, pdir = r'G:\OTDR_Data', DS_name='svm'):
        # Input
...
if __name__ == '__main__':
    ...
    y_hat = fit.tune_rbf(X_train, y_train, X_test, y_test, K = 5, plot = True,
                         pdir = r'G:\OTDR_Data', DS_name = 'Test dataset')
    acc = np.mean(y_hat == y_test)
